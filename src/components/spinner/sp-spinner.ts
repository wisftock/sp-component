...
import type { SpSpinnerSize, SpSpinnerVariant } from "./sp-spinner.types.js";
 ...
 * @prop {SpSpinnerVariant} variant - Visual style: arc | dots | bars | pulse | ring
